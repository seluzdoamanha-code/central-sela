        ...
        if (nome.includes('assistência') || nome.includes('social')) {
            html += `
                ...
                <a href="m_dash_ocorrencias.html" class="m-app-card">
                    <div class="m-app-icon" style="color: #ef4444;">
                        <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>
                    </div>
                    <div class="m-app-name">Ocorrências</div>
                </a>
            `;
            // Dynamic Icon in Nav
